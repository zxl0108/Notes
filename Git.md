...
![1563844471358](Git.assets/1563844471358.png)
...
![1563868996314](Git.assets/1563868996314.png)

**已暂存（staged）**，表示对一个已修改文件的当前版本做了标记，使之包含在下次提交的快照中

![1563869100350](Git.assets/1563869100350.png)

已修改（modified），文件被添加到暂存区，但是没有提交到仓库，然后在工作区对文件进行了修改。

![1563869228699](Git.assets/1563869228699.png)
